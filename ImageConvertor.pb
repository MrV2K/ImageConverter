...
Procedure Create_Window()
  ...
  If OpenWindow(#MAIN_WINDOW,0,0,670,195,"Image Converter",#PB_Window_SystemMenu|#PB_Window_ScreenCentered)
...
; DPIAware
; UseIcon = icon.ico
; Executable = ImageConvertor.exe
; Compiler = PureBasic 6.11 LTS - C Backend (Windows - x64)
; Debugger = Standalone